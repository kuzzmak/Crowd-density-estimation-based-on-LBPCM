...
class LBPCM:
    ...
    def calculateFeatureVectors(self, pathToProcessedData, progressbar, labelProgress, labelFVCSize, size):
        ...
        for pic in range(size):
            # staza do slike
            fileName = pathToProcessedData + "/" + pictures[pic]
