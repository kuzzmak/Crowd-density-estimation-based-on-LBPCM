...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Crowd density estimation based on local binary pattern \n" \
                       "co-occurence matrix - LBPCM", font=("Times", 18, "roman"))
        label.pack(side="top", pady=100)

        middleFrame = tk.Frame(self)
        middleFrame.pack(pady=20)

        # im1 = Image.open(os.path.join(controller.app.configuration['iconsDirectory'], "s1.png"))
        ...
        #
        # arrow1 = Image.open(os.path.join(controller.app.configuration['iconsDirectory'], "arrow.png"))
        ...
        #
        # im2 = Image.open(os.path.join(controller.app.configuration['iconsDirectory'], "s2.png"))
        ...
        #
        # lbp = tk.Label(middleFrame, text="LBP = 31", font=("Times", 12, "roman"))
        # lbp.pack(side="left", padx=10)

        buttonAgree = tk.Button(self, text="Main screen", command=lambda: controller.show_frame(iP.InitializationPage))
