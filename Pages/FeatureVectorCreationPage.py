...
class FeatureVectorCreationPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        labelDescription = tk.Label(self, text="Here you can add new configurations for classifier training")
        labelDescription.pack(padx=10, pady=10)

        processedImages = os.listdir(controller.app.configuration['processedDataDirectory'])
        labelProcessedImages = tk.Label(self, text="processed images: " + str(len(processedImages)))
        ...
        self.labelLabelsLoadedColor = tk.Label(loadedFrame, text="NOT LOADED", fg="red")
